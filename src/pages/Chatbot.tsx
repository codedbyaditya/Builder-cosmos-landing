...
const Chatbot: React.FC = () => {
  ...
  const getWelcomeMessage = () => {
    if (language === "hi") {
      return "नमस्ते! मैं बिंदिसा एग्रीटेक का AI कृषि सहायक हूं। मैं आपकी खेती संबंधी समस्याओं में मद��� कर सकता हूं। फसल, मि���्टी, कीट, मौसम, या कृषि से जुड़ा कोई भी सवाल पूछें।";
    } else if (language === "mr") {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const fallbackMessages = {
        ...
        hi: "मुझे खुशी है, लेकिन फिलहाल मुझे जुड़ने में समस्या हो रही है। कृपया थोड़ी देर बाद फिर कोशिश करें या तत्काल सहायता के लिए हमारे कृ���ि विशेषज्ञों से संपर्क करें।",
